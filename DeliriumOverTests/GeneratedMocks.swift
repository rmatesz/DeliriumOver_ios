// MARK: - Mocks generated from file: DeliriumOver/Logic/Calculations/AlcoholCalculator.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/DB/CoreData/CoreDataAdapter.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/DB/Firebase/FirebaseAuthentication.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/DB/Firebase/FirebaseSessionDatabase.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/Repository/ConsumptionRepository.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/Repository/DrinkRepository.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Logic/Repository/SessionRepository.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Presentation/Consumptions/Form/Interactor/ConsumptionFormInteractor.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Presentation/Consumptions/Form/Router/ConsumptionFormRouter.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOver/Presentation/Consumptions/Form/View/ConsumptionFormView.swift at 2020-11-02 22:27:26 +0000
...
import UIKit
 ...
 class MockConsumptionFormView: ConsumptionFormView, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("showAlert(title: String, message: String, action: String)",
            parameters: (title, message, action),
            escapingParameters: (title, message, action),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showAlert(title: title, message: message, action: action))
    ...
    return cuckoo_manager.call("hideLoadingIndicator()",
	 ...
	 struct __StubbingProxy_ConsumptionFormView: Cuckoo.StubbingProxy {
	    ...
	    func showAlert<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(title: M1, message: M2, action: M3) -> Cuckoo.ProtocolStubNoReturnFunction<(String, String, String)> where M1.MatchedType == String, M2.MatchedType == String, M3.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String, String, String)>] = [wrap(matchable: title) { $0.0 }, wrap(matchable: message) { $0.1 }, wrap(matchable: action) { $0.2 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockConsumptionFormView.self, method: "showAlert(title: String, message: String, action: String)", parameterMatchers: matchers))
	    }
	    
	    func showLoadingIndicator() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockConsumptionFormView.self, method: "showLoadingIndicator()", parameterMatchers: matchers))
	    }
	    
	    func hideLoadingIndicator() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockConsumptionFormView.self, method: "hideLoadingIndicator()", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ConsumptionFormView: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func showAlert<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(title: M1, message: M2, action: M3) -> Cuckoo.__DoNotUse<(String, String, String), Void> where M1.MatchedType == String, M2.MatchedType == String, M3.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String, String, String)>] = [wrap(matchable: title) { $0.0 }, wrap(matchable: message) { $0.1 }, wrap(matchable: action) { $0.2 }]
	        return cuckoo_manager.verify("showAlert(title: String, message: String, action: String)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: DeliriumOver/Util/Date/DateProvider.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOverTests/TestUtils/Mock/CoreData.swift at 2020-11-02 22:27:26 +0000
...
// MARK: - Mocks generated from file: DeliriumOverTests/TestUtils/Mock/Firebase.swift at 2020-11-02 22:27:26 +0000
